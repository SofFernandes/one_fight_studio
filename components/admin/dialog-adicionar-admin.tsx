...
import { criarAdminAdmin } from "@/app/actions/usuarios";
...
export function DialogAdicionarAdmin() {
  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      const resultado = await criarAdminAdmin(undefined, formData);
      if (resultado?.erro) {
        ...
        <form ref={formRef} action={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Informe essa senha para o novo admin pessoalmente.
            </p>
          </div>
